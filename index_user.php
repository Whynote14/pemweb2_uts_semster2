        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="templateuser/img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <h1 class="display-1 text-white animated slideInRight mb-3">Award Winning Laboratory Center</h1>
                                    <p class="mb-5 animated slideInRight">Sebuah Pusat Laboratorium yang meraih penghargaan merupakan pusat penelitian atau fasilitas laboratorium yang telah diakui atas prestasinya dalam berbagai bidang, seperti ilmu pengetahuan, teknologi, atau kesehatan. </p>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="templateuser/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <h1 class="display-1 text-white animated slideInLeft mb-3">Expet Doctors & Lab Assistants</h1>
                                    <p class="mb-5 animated slideInLeft">Sebuah Pusat Laboratorium yang meraih penghargaan merupakan pusat penelitian atau fasilitas laboratorium yang telah diakui atas prestasinya dalam berbagai bidang, seperti ilmu pengetahuan, teknologi, atau kesehatan.</p>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="row g-0">
                        <div class="col-6">
                            <img class="img-fluid" src="templateuser/img/about-1.jpg">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="templateuser/img/about-2.jpg">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid" src="templateuser/img/about-3.jpg">
                        </div>
                        <div class="col-6">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-4">Pakar Lab Tepercaya dan Teknologi Lab Terbaru</h1>
                    <p class="mb-4">
Pakar Laboratorium yang tepercaya adalah individu yang memiliki pengetahuan mendalam dan pengalaman yang luas dalam bidangnya. </p>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Ini mengacu pada suatu prestasi atau produk yang telah diakui dan diberikan penghargaan atas kualitasnya dalam suatu kompetisi atau penilaian. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0"> Dokter ahli adalah praktisi medis yang memiliki pengetahuan mendalam dan keterampilan khusus dalam bidang tertentu dalam kedokteran. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Istilah ini mengacu pada harga yang dianggap secara umum sebagai tidak terlalu mahal dan tidak terlalu murah, tetapi sebanding dengan nilai atau kualitas produk atau layanan yang diberikan. </p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">"24/7 Support" mengacu pada layanan dukungan atau bantuan yang tersedia sepanjang waktu, 24 jam sehari, 7 hari seminggu.</p>
                    </div>
                </div>
            </div>
        </div>
